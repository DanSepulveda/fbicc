export const vocabulary = {
  ...
  class2: [
    ...
    { indonesian: 'dia', english: 'he, she', tags: [] },
    { indonesian: 'dimana', english: 'where', tags: [] },
    { indonesian: 'halo', english: 'hello', tags: [] }, // !left
    { indonesian: 'itu', english: 'that', tags: [] },
    { indonesian: 'juga', english: 'too', tags: [] }, // !left
    { indonesian: 'kabar', english: 'news', tags: [] }, // !left
    ...
    { indonesian: 'manyapa', english: 'greetings', tags: [] }, // !left
    { indonesian: 'mereka', english: 'they', tags: [] },
    { indonesian: 'nama', english: 'name', tags: [] },
    ...
    { indonesian: 'sore', english: 'afternoon (from 3pm)', tags: [] },
    { indonesian: 'tinggal', english: 'live', tags: [] },
    { indonesian: 'terima kasih', english: 'thank you', tags: [] }
  ],
  class3: [
    { indonesian: 'adik laki-laki', english: 'younger brother', tags: ['awf'] },
    { indonesian: 'adik perempuan', english: 'younger sister', tags: ['awf'] }, // !left
    { indonesian: 'anak', english: 'child', tags: ['awf'] },
    { indonesian: 'anak-anak', english: 'children', tags: [] },
    { indonesian: 'anak bungsu', english: 'last child', tags: ['awf'] }, // !left
    { indonesian: 'anak laki-laki', english: 'son', tags: ['awf'] }, // !left
    { indonesian: 'anak perempuan', english: 'daughter', tags: ['awf'] }, // !left
    { indonesian: 'anak sulung', english: 'first child', tags: ['awf'] }, // !left
    { indonesian: 'anak tengah', english: 'middle child', tags: ['awf'] }, // !left
    { indonesian: 'anak tunggal', english: 'only child', tags: [] }, // !left
    { indonesian: 'anggota keluarga', english: 'family member', tags: [] }, // !left
    ...
    { indonesian: 'cucu perempuan', english: 'granddaughter', tags: ['awf'] }, // !left
    { indonesian: 'ibu', english: 'mother', tags: ['awf'] },
    { indonesian: 'ibu mertua', english: 'mother-in-law', tags: ['awf'] }, // !left
    { indonesian: 'istri', english: 'wife', tags: ['awf'] },
    { indonesian: 'kakek', english: 'grandfather', tags: ['awf'] },
    { indonesian: 'keluarga', english: 'family', tags: [] },
    ...
    { indonesian: 'sepupu laki-laki', english: 'male cousin', tags: ['awf'] }, // !left
    { indonesian: 'sepupu perempuan', english: 'female cousin', tags: ['awf'] }, // !left
    { indonesian: 'suami', english: 'husband', tags: ['awf'] },
  ...
  class4: [
    ...
    { indonesian: 'kadang-kadang', english: 'sometimes', tags: [] },
    { indonesian: 'kantor', english: 'office', tags: [] },
    { indonesian: 'kerja', english: 'to work', tags: [] }, // !left
    { indonesian: 'lagu', english: 'song', tags: [] },
    { indonesian: 'main', english: 'to play', tags: [] },
    { indonesian: 'main game', english: 'to play a game', tags: [] },
    { indonesian: 'makan', english: 'to eat', tags: [] },
    { indonesian: 'mancing', english: 'to fish', tags: [] }, // !left
    { indonesian: 'mandi', english: 'to take a shower', tags: [] }, // !left
    { indonesian: 'masak', english: 'to cook', tags: [] },
    { indonesian: 'melukis', english: 'to paint', tags: [] }, // !left
    { indonesian: 'mendengarkan lagu', english: 'to listen a song', tags: [] },
    ...
    { indonesian: 'renang', english: 'to swim', tags: [] },
  ...
  class5: [
    { indonesian: 'tiga', english: 'three', tags: [] },
    { indonesian: 'empat', english: 'four', tags: [] },
    { indonesian: 'tujuh', english: 'seven', tags: [] },
    { indonesian: 'delapan', english: 'eight', tags: [] },
    { indonesian: 'sepuluh', english: 'ten', tags: [] },
    ...
    { indonesian: 'kamis', english: 'thursday', tags: [] }, // !left
    { indonesian: 'jumat', english: 'friday', tags: [] },
    { indonesian: 'sabtu', english: 'saturday', tags: [] }, // !left
    { indonesian: 'januari', english: 'january', tags: [] }, // !left
    { indonesian: 'februari', english: 'february', tags: [] }, // !left
    { indonesian: 'maret', english: 'march', tags: [] },
    { indonesian: 'april', english: 'april', tags: [] }, // !left
    { indonesian: 'mei', english: 'may', tags: [] },
    { indonesian: 'juni', english: 'june', tags: [] }, // !left
    { indonesian: 'juli', english: 'july', tags: [] }, // !left
    { indonesian: 'agustus', english: 'august', tags: [] },
    { indonesian: 'september', english: 'september', tags: [] }, // !left
    { indonesian: 'oktober', english: 'october', tags: [] }, // !left
    { indonesian: 'november', english: 'november', tags: [] }, // !left
    { indonesian: 'desember', english: 'december', tags: [] }, // !left
    { indonesian: 'kemarin', english: 'yesterday', tags: [] },
    { indonesian: 'hari ini', english: 'today', tags: [] },
    { indonesian: 'besok', english: 'tomorrow', tags: [] },
    { indonesian: 'lusa', english: 'the day after tomorrow', tags: [] },
    { indonesian: 'minggu lalu', english: 'last week', tags: [] }, // !left
    { indonesian: 'minggu ini', english: 'this week', tags: [] }, // !left
    { indonesian: 'minggu depan', english: 'next week', tags: [] },
    { indonesian: 'dua minggu lagi', english: 'next two weeks', tags: [] }, // !left
    { indonesian: 'bulan lalu', english: 'last month', tags: [] }, // !left
    { indonesian: 'bulan ini', english: 'this month', tags: [] }, // !left
    { indonesian: 'bulan depan', english: 'next month', tags: [] }, // !left
    { indonesian: 'dua bulan lagi', english: 'next two months', tags: [] }, // !left
    { indonesian: 'tahun lalu', english: 'last year', tags: [] }, // !left
  ...
  class8: [
    { indonesian: 'asam', english: 'sour', tags: [] }, // !left
    { indonesian: 'asin', english: 'salty', tags: [] }, // !left
    { indonesian: 'cemilan', english: 'snack', tags: [] }, // !left
    { indonesian: 'coba', english: 'to try', tags: [] }, // !left
    { indonesian: 'gurih', english: 'savory', tags: [] }, // !left
    { indonesian: 'harum', english: 'fragant, aromatic', tags: [] }, // !left
    { indonesian: 'ingin', english: 'want (formal)', tags: [] }, // !left
    { indonesian: 'jus jeruk', english: 'orange juice', tags: [] },
    { indonesian: 'makanan', english: 'food', tags: [] }, // !left
    { indonesian: 'makan malam', english: 'dinner', tags: [] }, // !left
    { indonesian: 'makan siang', english: 'lunch', tags: [] }, // !left
    { indonesian: 'manis', english: 'sweet', tags: [] }, // !left
    { indonesian: 'mau', english: 'want (less formal)', tags: [] }, // !left
    { indonesian: 'minumam', english: 'drink', tags: [] }, // !left
    { indonesian: 'pahit', english: 'bitter', tags: [] }, // !left
    { indonesian: 'pedas', english: 'spicy', tags: [] }, // !left
